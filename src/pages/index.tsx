...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>5ireLand</title>
        <meta name="description" content="5ireLand" />
      ...
      <main className="px-4 md:px-0 mx-auto max-w-[1080px]">
        ...
        <div className="pt-5 pb-20 mx-auto max-w-7xl">
          ...
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
            ...
            <FeatureCard icon={<MdSecurity size={25} />} title="Security" desc="Everything on-chain! Prevent any forgery and errors while verifying a claim. No one can change RoR except the authorized person." />
            <FeatureCard icon={<BsFillCheckCircleFill size={25} />} title="Verification" desc="It also ensures that the right person is performing transaction or deal of the land. User can also transfer ownership after KYC process." />
          </dl>
        </div>
      </main>
    </>
